...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        EnginePurgeLabel->setFont(font3);
        ...
        font4.setBold(true);
        font4.setWeight(75);
        EnginePurgeState->setFont(font4);
        ...
        InjectorChillLabel->setFont(font3);
        ...
        InjectorChillState->setFont(font4);
